...
## Prerequisites Good for you gut technic huvi vivo

tggf

- Active Claude subscription (Pro, Max, or API access)vvvvv ghh
...
- Make assumptions - always ask for clarif
```
